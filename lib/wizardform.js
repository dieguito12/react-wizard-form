...
class WizardForm extends React.Component {
        ...
        this.nextStep = (data) => {
            if (this.state.elements.length - this.state.step > 1) {
                ...
                this.state.elements.forEach((obj, i) => {
                    newElements.push(React.cloneElement(obj, Object.assign({}, params, { key: 'react-wizard-form-step-' + i })));
                });
                if (this.props.onStepChanged) {
    ...
    componentDidMount() {
        ...
        let AllComponents = [];
        this.state.elements.forEach((obj, i) => {
            AllComponents.push(React.cloneElement(obj, Object.assign({}, params, { key: 'react-wizard-form-step-' + i })));
        });
    ...
    render() {
        ...
        if (this.props.headers) {
            this.props.headers.forEach((obj, i) => {
                AllHeaders.push(React.cloneElement(obj, Object.assign({}, headersParam, { key: 'react-wizard-form-header-' + i })));
            });
        }
